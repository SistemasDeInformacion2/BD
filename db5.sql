...
-- exported at Wed Jun 01 12:08:05 BOT 2016 with easyDesigner
-- -------------------------------------------------------------------------
...
ALTER TABLE "MIEMBRO EQUIPO" ADD FOREIGN KEY ("MIEMBRO EQUIPO_ID_EQ") 
    REFERENCES "MIEMBRO EQUIPO" ("ID_EQ")
      ON DELETE CASCADE
      ON UPDATE CASCADE;
ALTER TABLE "MIEMBRO EQUIPO" ADD FOREIGN KEY ("TRABAJADOR_ID_TRAB") 
...
-- -------------------------------------------------------------------------
ALTER TABLE "PRODUCT OWNER" ADD FOREIGN KEY ("TRABAJADOR_ID_TRAB") 
    REFERENCES "TRABAJADOR" ("ID_TRAB")
      ON DELETE NO ACTION
      ON UPDATE NO ACTION;
